...
- **Dashboard tile grid** for selecting dashboards
- **Full dashboard viewer** with real-time data refresh
...
| Section | Purpose |
|---------|---------|
| **Connections** | Configure data sources (SQL, API, WebSocket, MQTT, etc.) |
| **Components** | Create charts, controls, and display components |
| **Dashboards** | View and manage dashboard list |
...
| **Device Types** | Define device types with command schemas for controls |
| **Settings** | Configure system-wide settings (layout presets, refresh intervals) |
